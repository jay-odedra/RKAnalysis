...
#######################################
    ...
    parser.add_option('-a', '--application',   action='store',      dest='application',   help='the executable to be run'                                  , default='/afs/cern.ch/work/c/crovelli/BPhys/BParkAnalysisTools/BParkApp')
