...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nBToKEE;
   Float_t         BToKEE_b_iso03[4000];   //[nBToKEE]
   Float_t         BToKEE_b_iso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_b_iso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_b_iso04[4000];   //[nBToKEE]
   Float_t         BToKEE_b_iso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_b_iso04_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_cos2D[4000];   //[nBToKEE]
   Float_t         BToKEE_eta[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_cos2D[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_eta[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_k_eta[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_k_phi[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_k_pt[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l1_eta[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l1_phi[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l1_pt[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l2_eta[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l2_phi[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_l2_pt[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_mass[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_massErr[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_phi[4000];   //[nBToKEE]
   Float_t         BToKEE_fit_pt[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso03[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso04[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_k_iso04_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_k_svip2d[4000];   //[nBToKEE]
   Float_t         BToKEE_k_svip2d_err[4000];   //[nBToKEE]
   Float_t         BToKEE_k_svip3d[4000];   //[nBToKEE]
   Float_t         BToKEE_k_svip3d_err[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso03[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso04[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_iso04_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso03[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso04[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_iso04_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l_xy[4000];   //[nBToKEE]
   Float_t         BToKEE_l_xy_unc[4000];   //[nBToKEE]
   Float_t         BToKEE_mass[4000];   //[nBToKEE]
   Float_t         BToKEE_maxDR[4000];   //[nBToKEE]
   Float_t         BToKEE_minDR[4000];   //[nBToKEE]
   Float_t         BToKEE_mllErr_llfit[4000];   //[nBToKEE]
   Float_t         BToKEE_mll_fullfit[4000];   //[nBToKEE]
   Float_t         BToKEE_mll_llfit[4000];   //[nBToKEE]
   Float_t         BToKEE_mll_raw[4000];   //[nBToKEE]
   Float_t         BToKEE_phi[4000];   //[nBToKEE]
   Float_t         BToKEE_pt[4000];   //[nBToKEE]
   Float_t         BToKEE_svprob[4000];   //[nBToKEE]
   Float_t         BToKEE_vtx_ex[4000];   //[nBToKEE]
   Float_t         BToKEE_vtx_ey[4000];   //[nBToKEE]
   Float_t         BToKEE_vtx_ez[4000];   //[nBToKEE]
   ...
   Int_t           BToKEE_pdgId[4000];   //[nBToKEE]
   UInt_t          nBToKMuMu;
   Float_t         BToKMuMu_b_iso03[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_iso03_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_iso03_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_iso04[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_iso04_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_iso04_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_cos2D[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_eta[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_cos2D[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_eta[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_k_eta[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_k_phi[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_k_pt[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l1_eta[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l1_phi[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l1_pt[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l2_eta[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l2_phi[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_l2_pt[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_mass[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_massErr[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_phi[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_fit_pt[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso03[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso03_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso03_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso04[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso04_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_iso04_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_svip2d[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_svip2d_err[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_svip3d[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_svip3d_err[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso03[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso03_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso03_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso04[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso04_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_iso04_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso03[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso03_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso03_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso04[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso04_dca[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_iso04_dca_tight[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l_xy[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_l_xy_unc[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_mass[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_maxDR[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_minDR[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_mllErr_llfit[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_mll_fullfit[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_mll_llfit[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_mll_raw[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_phi[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_pt[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_svprob[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_ex[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_ey[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_ez[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_x[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_y[3000];   //[nBToKMuMu]
   Float_t         BToKMuMu_vtx_z[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_b_n_isotrk[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_b_n_isotrk_dca[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_b_n_isotrk_dca_tight[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_charge[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_kIdx[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_k_n_isotrk[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_k_n_isotrk_dca[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_k_n_isotrk_dca_tight[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l1Idx[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l1_n_isotrk[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l1_n_isotrk_dca[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l1_n_isotrk_dca_tight[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l2Idx[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l2_n_isotrk[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l2_n_isotrk_dca[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_l2_n_isotrk_dca_tight[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_n_k_used[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_n_l1_used[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_n_l2_used[3000];   //[nBToKMuMu]
   Int_t           BToKMuMu_pdgId[3000];   //[nBToKMuMu]
   // KStar stuff
   UInt_t          nBToKsEE;
   Float_t         BToKsEE_b_iso03[500];   //[nBToKsEE]
   Float_t         BToKsEE_b_iso04[500];   //[nBToKsEE]
   Float_t         BToKsEE_barMass[500];   //[nBToKsEE]
   Float_t         BToKsEE_chi2[500];   //[nBToKsEE]
   Float_t         BToKsEE_cos2D[500];   //[nBToKsEE]
   Float_t         BToKsEE_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_barKstar_mass[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_barMass[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_cos2D[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_mass[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_mass[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_massErr[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_eta[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_l1_iso03[500];   //[nBToKsEE]
   Float_t         BToKsEE_l1_iso04[500];   //[nBToKsEE]
   Float_t         BToKsEE_l2_iso03[500];   //[nBToKsEE]
   Float_t         BToKsEE_l2_iso04[500];   //[nBToKsEE]
   Float_t         BToKsEE_l_xy[500];   //[nBToKsEE]
   Float_t         BToKsEE_l_xy_unc[500];   //[nBToKsEE]
   Float_t         BToKsEE_mass[500];   //[nBToKsEE]
   Float_t         BToKsEE_max_dr[500];   //[nBToKsEE]
   Float_t         BToKsEE_min_dr[500];   //[nBToKsEE]
   Float_t         BToKsEE_mll_fullfit[500];   //[nBToKsEE]
   Float_t         BToKsEE_mll_llfit[500];   //[nBToKsEE]
   Float_t         BToKsEE_mll_raw[500];   //[nBToKsEE]
   Float_t         BToKsEE_phi[500];   //[nBToKsEE]
   Float_t         BToKsEE_pt[500];   //[nBToKsEE]
   Float_t         BToKsEE_svprob[500];   //[nBToKsEE]
   Float_t         BToKsEE_tk1_iso03[500];   //[nBToKsEE]
   Float_t         BToKsEE_tk1_iso04[500];   //[nBToKsEE]
   Float_t         BToKsEE_tk2_iso03[500];   //[nBToKsEE]
   Float_t         BToKsEE_tk2_iso04[500];   //[nBToKsEE]
   Int_t           BToKsEE_charge[500];   //[nBToKsEE]
   Int_t           BToKsEE_kstar_idx[500];   //[nBToKsEE]
   Int_t           BToKsEE_l1_idx[500];   //[nBToKsEE]
   Int_t           BToKsEE_l2_idx[500];   //[nBToKsEE]
   Int_t           BToKsEE_pdgId[500];   //[nBToKsEE]
   Int_t           BToKsEE_trk1_idx[500];   //[nBToKsEE]
   Int_t           BToKsEE_trk2_idx[500];   //[nBToKsEE]
   UInt_t          nBToKsMuMu;
   Float_t         BToKsMuMu_b_iso03[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_b_iso04[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_barMass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_chi2[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_cos2D[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_barKstar_mass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_barMass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_cos2D[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_mass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_mass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_massErr[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_eta[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l1_iso03[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l1_iso04[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l2_iso03[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l2_iso04[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l_xy[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l_xy_unc[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mass[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_max_dr[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_min_dr[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_fullfit[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_llfit[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_raw[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_phi[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_pt[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_svprob[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk1_iso03[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk1_iso04[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk2_iso03[300];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk2_iso04[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_charge[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_kstar_idx[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_l1_idx[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_l2_idx[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_pdgId[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_trk1_idx[300];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_trk2_idx[300];   //[nBToKsMuMu]
   UInt_t          nKstar;
   Float_t         Kstar_barMass[1000];   //[nKstar]
   Float_t         Kstar_eta[1000];   //[nKstar]
   Float_t         Kstar_fitted_barMass[1000];   //[nKstar]
   Float_t         Kstar_fitted_eta[1000];   //[nKstar]
   Float_t         Kstar_fitted_mass[1000];   //[nKstar]
   Float_t         Kstar_fitted_phi[1000];   //[nKstar]
   Float_t         Kstar_fitted_pt[1000];   //[nKstar]
   Float_t         Kstar_mass[1000];   //[nKstar]
   Float_t         Kstar_phi[1000];   //[nKstar]
   Float_t         Kstar_pt[1000];   //[nKstar]
   Float_t         Kstar_svprob[1000];   //[nKstar]
   Float_t         Kstar_trk_deltaR[1000];   //[nKstar]
   Int_t           Kstar_charge[1000];   //[nKstar]
   Int_t           Kstar_pdgId[1000];   //[nKstar]
   Int_t           Kstar_trk1_idx[1000];   //[nKstar]
   Int_t           Kstar_trk2_idx[1000];   //[nKstar]
   UInt_t          nElectron;
   Float_t         Electron_convChi2Prob[1500];   //[nElectron]
   Float_t         Electron_convDeltaCotFromPin[1500];   //[nElectron]
   Float_t         Electron_convLxy[1500];   //[nElectron]
   Float_t         Electron_convMass[1500];   //[nElectron]
   Float_t         Electron_convMassAfterFit[1500];   //[nElectron]
   Float_t         Electron_convMassBeforeFit[1500];   //[nElectron]
   Float_t         Electron_convMassFromPin[1500];   //[nElectron]
   Float_t         Electron_convMinTrkPt[1500];   //[nElectron]
   Float_t         Electron_convVtxRadius[1500];   //[nElectron]
   Float_t         Electron_dxy[1500];   //[nElectron]
   Float_t         Electron_dxyErr[1500];   //[nElectron]
   Float_t         Electron_dz[1500];   //[nElectron]
   Float_t         Electron_dzErr[1500];   //[nElectron]
   Float_t         Electron_dzTrg[1500];   //[nElectron]
   Float_t         Electron_eta[1500];   //[nElectron]
   Float_t         Electron_fBrem[1500];   //[nElectron]
   Float_t         Electron_ip3d[1500];   //[nElectron]
   Float_t         Electron_mass[1500];   //[nElectron]
   Float_t         Electron_mvaId[1500];   //[nElectron]
   Float_t         Electron_pfRelIso[1500];   //[nElectron]
   Float_t         Electron_pfmvaId[1500];   //[nElectron]
   Float_t         Electron_phi[1500];   //[nElectron]
   Float_t         Electron_pt[1500];   //[nElectron]
   Float_t         Electron_ptBiased[1500];   //[nElectron]
   Float_t         Electron_sip3d[1500];   //[nElectron]
   Float_t         Electron_trkRelIso[1500];   //[nElectron]
   Float_t         Electron_unBiased[1500];   //[nElectron]
   Float_t         Electron_vx[1500];   //[nElectron]
   Float_t         Electron_vy[1500];   //[nElectron]
   Float_t         Electron_vz[1500];   //[nElectron]
   Int_t           Electron_charge[1500];   //[nElectron]
   Int_t           Electron_convDeltaExpectedNHitsInner[1500];   //[nElectron]
   Int_t           Electron_convLeadIdx[1500];   //[nElectron]
   Int_t           Electron_convLeadNHitsBeforeVtx[1500];   //[nElectron]
   Int_t           Electron_convMaxNHitsBeforeVtx[1500];   //[nElectron]
   Int_t           Electron_convSumNHitsBeforeVtx[1500];   //[nElectron]
   Int_t           Electron_convTracksN[1500];   //[nElectron]
   Int_t           Electron_convTrailIdx[1500];   //[nElectron]
   Int_t           Electron_convTrailNHitsBeforeVtx[1500];   //[nElectron]
   Int_t           Electron_pdgId[1500];   //[nElectron]
   Bool_t          Electron_convExtra[1500];   //[nElectron]
   Bool_t          Electron_convLead[1500];   //[nElectron]
   Bool_t          Electron_convLoose[1500];   //[nElectron]
   Bool_t          Electron_convOpen[1500];   //[nElectron]
   Bool_t          Electron_convQualityHighEff[1500];   //[nElectron]
   Bool_t          Electron_convQualityHighPurity[1500];   //[nElectron]
   Bool_t          Electron_convTight[1500];   //[nElectron]
   Bool_t          Electron_convTrail[1500];   //[nElectron]
   Bool_t          Electron_convValid[1500];   //[nElectron]
   Bool_t          Electron_convVeto[1500];   //[nElectron]
   Bool_t          Electron_isLowPt[1500];   //[nElectron]
   Bool_t          Electron_isPF[1500];   //[nElectron]
   Bool_t          Electron_isPFoverlap[1500];   //[nElectron]
   UInt_t          nGenPart;
   Float_t         GenPart_eta[1500];   //[nGenPart]
   Float_t         GenPart_mass[1500];   //[nGenPart]
   Float_t         GenPart_phi[1500];   //[nGenPart]
   Float_t         GenPart_pt[1500];   //[nGenPart]
   Float_t         GenPart_vx[1500];   //[nGenPart]
   Float_t         GenPart_vy[1500];   //[nGenPart]
   Float_t         GenPart_vz[1500];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[1500];   //[nGenPart]
   Int_t           GenPart_pdgId[1500];   //[nGenPart]
   Int_t           GenPart_status[1500];   //[nGenPart]
   Int_t           GenPart_statusFlags[1500];   //[nGenPart]
   ...
   UInt_t          nMuon;
   Float_t         Muon_dxy[1500];   //[nMuon]
   Float_t         Muon_dxyErr[1500];   //[nMuon]
   Float_t         Muon_dz[1500];   //[nMuon]
   Float_t         Muon_dzErr[1500];   //[nMuon]
   Float_t         Muon_eta[1500];   //[nMuon]
   Float_t         Muon_ip3d[1500];   //[nMuon]
   Float_t         Muon_mass[1500];   //[nMuon]
   Float_t         Muon_matched_dpt[1500];   //[nMuon]
   Float_t         Muon_matched_dr[1500];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[1500];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[1500];   //[nMuon]
   Float_t         Muon_phi[1500];   //[nMuon]
   Float_t         Muon_pt[1500];   //[nMuon]
   Float_t         Muon_ptErr[1500];   //[nMuon]
   Float_t         Muon_sip3d[1500];   //[nMuon]
   Float_t         Muon_vx[1500];   //[nMuon]
   Float_t         Muon_vy[1500];   //[nMuon]
   Float_t         Muon_vz[1500];   //[nMuon]
   Int_t           Muon_charge[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu10p5_IP3p5[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu12_IP6[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu20_IP4[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu7_IP4[1500];   //!
   Int_t           Muon_fired_HLT_Mu8_IP3[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8_IP5[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8_IP6[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8p5_IP3p5[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP4[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP5[1500];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP6[1500];   //[nMuon]
   Int_t           Muon_isTriggering[1500];   //[nMuon]
   Int_t           Muon_looseId[1500];   //[nMuon]
   Int_t           Muon_pdgId[1500];   //[nMuon]
   Bool_t          Muon_isGlobal[1500];   //[nMuon]
   Bool_t          Muon_isPFcand[1500];   //[nMuon]
   Bool_t          Muon_isTracker[1500];   //[nMuon]
   Bool_t          Muon_mediumId[1500];   //[nMuon]
   UChar_t         Muon_pfIsoId[1500];   //[nMuon]
   Bool_t          Muon_softId[1500];   //[nMuon]
   Bool_t          Muon_tightId[1500];   //[nMuon]
   UChar_t         Muon_tkIsoId[1500];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[1500];   //[nMuon]
   ...
   UInt_t          nProbeTracks;
   Float_t         ProbeTracks_DCASig[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_dxy[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_dxyS[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_dz[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_dzS[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_dzTrg[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_eta[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_mass[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_phi[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_pt[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_vx[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_vy[3500];   //[nProbeTracks]
   Float_t         ProbeTracks_vz[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_charge[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_isLostTrk[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_isPacked[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_nValidHits[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_pdgId[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToEle[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToLooseMuon[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToLowPtEle[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToMediumMuon[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToMuon[3500];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToSoftMuon[3500];   //[nProbeTracks]
   UChar_t         HLT_Mu7_IP4;
   UChar_t         HLT_Mu8_IP6;
   UChar_t         HLT_Mu8_IP5;
   UChar_t         HLT_Mu8_IP3;
   ...
   Int_t           TrigObj_id[100];   //[nTrigObj]
   Int_t           TrigObj_l1iso[100];   //[nTrigObj]
   Int_t           TrigObj_l1charge[100];   //[nTrigObj]
   ...
   Int_t           PV_npvsGood;
   UInt_t          nSV;
   Float_t         SV_dlen[700];   //[nSV]
   Float_t         SV_dlenSig[700];   //[nSV]
   Float_t         SV_pAngle[700];   //[nSV]
   Int_t           Electron_genPartIdx[1500];   //[nElectron]
   Int_t           Electron_genPartFlav[1500];   //[nElectron]
   Int_t           Muon_genPartIdx[1500];   //[nMuon]
   Int_t           Muon_genPartFlav[1500];   //[nMuon]
   Float_t         SV_chi2[700];   //[nSV]
   Float_t         SV_eta[700];   //[nSV]
   Float_t         SV_mass[700];   //[nSV]
   Float_t         SV_ndof[700];   //[nSV]
   Float_t         SV_phi[700];   //[nSV]
   Float_t         SV_pt[700];   //[nSV]
   Float_t         SV_x[700];   //[nSV]
   Float_t         SV_y[700];   //[nSV]
   Float_t         SV_z[700];   //[nSV]
   Int_t           ProbeTracks_genPartIdx[3500];   //[nProbeTracks]
   Int_t           ProbeTracks_genPartFlav[3500];   //[nProbeTracks]
   ...
   BParkBase(TTree *tree=0, int isMC=0);
   virtual ~BParkBase();
...
#ifdef BParkBase_cxx
BParkBase::BParkBase(TTree *tree, int isMC ) : fChain(0) 
{
